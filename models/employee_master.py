...
class EmployeeMaster(models.Model):
    ...
    department_code = fields.Many2one('department.master', string='Department' , required=True, help='Enter Department Code', index = True)
    class_code = fields.Many2one('employee.class.master', string='Class' , required=True, help='Enter Department Code', index = True)
